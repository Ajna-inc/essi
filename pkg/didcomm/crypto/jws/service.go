...
func (s *JwsService) CreateJws(ctx *corectx.AgentContext, options CreateJwsOptions) (*Jws, error) {
	// Get the signing key
...
func (s *JwsService) VerifyJws(ctx *corectx.AgentContext, jws *Jws, payload []byte) (bool, error) {
